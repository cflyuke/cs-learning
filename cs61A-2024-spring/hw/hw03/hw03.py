...
def digit_distance(n):
    ...
    return digit_distance(all_but_last)+abs(last_second-last)
...
def count_coins(total):
    ...
    def limit_count(n,m):
        if n == 0 or m==None:
            ...
            return limit_count(n-m,m) + limit_count(n,next_smaller_coin(m))
        else :
            return limit_count(n,next_smaller_coin(m))
    return limit_count(total,25)
